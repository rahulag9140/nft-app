...
import { TicketSystem } from "../src/types";
...
async function main() {
  ...
  const logo = (await TicketSystem.attach(CONTRACT_ADDRESS)) as TicketSystem;

  console.log("TicketSystem deployed to:", logo.address);
